...
from models.hyperparameters_search import gcn_hyperparameters_search
from models.hyperparameters_search import gat_hyperparameters_search
from models.hyperparameters_search import transformer_hyperparameters_search
...
def run_net_models():
    ...
    for idx, path in enumerate(poly_path):
        ...
        print(f'\n\n---------Transformer---------')
        transf_res = transformer_hyperparameters_search.main(path, len(features[idx]))
        total_res_gcn.append(gcn_res), total_res_gat.append(gat_res), total_res_transf.append(transf_res)
