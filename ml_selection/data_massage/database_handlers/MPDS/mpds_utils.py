...
def get_structure_with_exist_poly(
    sid: str, api_key: str, from_dir: bool = False, entry: str = None
) -> tuple:
    ...
    # get cif from local dir, by entry
        ...
        onlyfiles = [
            f
            for f in listdir("ml_selection/cif")
            if isfile(join("ml_selection/cif", f))
        ]
