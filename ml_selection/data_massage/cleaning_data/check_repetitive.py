...
def check_disagreements(
    path_mpds: str = None, path_mp: str = None, from_conf: bool = True
):
    """
    ...
    mp_seebeck = pl.read_json(path_mp + "seebeck_sg_mp.json").rename(
        {"Seebeck coefficient": "Seebeck mp"}
    )
    mpds_seebeck = pl.read_json(path_mpds + "seebeck.json").rename(
        {"Phase": "phase_id", "Seebeck coefficient": "Seebeck mpds"}
    )
